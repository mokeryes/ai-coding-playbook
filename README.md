...
想象你开了一家餐厅,花了三年时间总结出一套 **"菜单 + 厨房守则 + 员工手册"**:

> 这道菜先放盐还是先放糖、用完锅要怎么洗、客人投诉怎么处理、交班时要写什么交接单……

现在你要开第二家分店 —— 你**不必从零再总结一遍**,直接把那套手册搬过去就行。第二家、第三家、第十家,每家"做事方式"完全一致。

**这个仓库就是那本"手册",但不是给真人员工用的,而是给 AI 编程助手用的。**

当你让 AI 帮你写代码时,这套手册告诉 AI:

- 代码要怎么写才整齐 — 别东一榔头西一棒槌
- 改完代码怎么向你"交差" — 而不是丢一堆文件让你自己看
- 出问题怎么和你商量 — 而不是擅自决定就开干
- 怎么记下"今天做到哪儿了"—— 明天换个会话也能接着干不忘事

**一份手册,N 个项目反复用。** 开新项目时一行命令把手册搬过去,只填几处"项目名 / 主营业务",剩下规矩照抄。AI 助手一进新项目就懂"家里的规矩",不用你每次重新教。
